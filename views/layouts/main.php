        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                ...
                <div class="navbar nav_title" style="border: 0;">
                    <a href="<?= Url::to(['/']) ?>" class="site_title"><i class="fa fa-shopping-cart"></i> <span><?= Yii::$app->name ?></span></a>
                </div>
...
if ($userBalanceModule = Yii::$app->getModule('user-balance')) $items[] = ['label' => 'User balance', 'url' => ['/user-balance/default/index'], 'icon' => 'money'];
